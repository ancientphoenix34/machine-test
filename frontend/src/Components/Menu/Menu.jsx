...
const Menu = () => {
  ...
  const fetchMenus = async () => {
    try {
      const response = await axios.get('https://machine-test-frontend.onrender.com/api/menus/getMenus');
  ...
  const fetchMenuItems = async (menuId) => {
    try {
      const response = await axios.get(`https://machine-test-frontend.onrender.com/api/menus/getMenuById/${menuId}`);
